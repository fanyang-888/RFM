...
- Tracked sample artifacts for quick review:
  - `outputs/kmeans_metrics.csv`
  - `outputs/segment_value_summary.csv`
  - `outputs/segment_action_plan.csv`
- Additional artifacts generated on run via `python scripts/run_rfm_segmentation.py`:
...
├── outputs/  (sample artifacts tracked; full set generated on run)
│   ├── kmeans_metrics.csv
